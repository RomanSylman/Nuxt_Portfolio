<template>
  <div>
    ...
    >
      <div class="center" :style="[backgroundSpinnerStyle]"/>
      <div class="inner-spin" :style="[innerSpinStyle]">
        <div
          class="inner-arc inner-arc_start-a"
          :style="[borderSpinnerStyle, arc(0)]"
        />
        <div
          class="inner-arc inner-arc_end-a"
          :style="[borderSpinnerStyle, arc(0)]"
        />
        <div
          class="inner-arc inner-arc_start-b"
          :style="[borderSpinnerStyle, arc(0)]"
        />
        <div
          class="inner-arc inner-arc_end-b"
          :style="[borderSpinnerStyle, arc(0)]"
        />
        <div
          class="inner-moon-a"
          :style="[backgroundSpinnerStyle, moon(0, 0)]"
        />
        <div
          class="inner-moon-b"
          :style="[backgroundSpinnerStyle, moon(0, 1)]"
        />
      </div>
      <div class="outer-spin" :style="[outerSpinStyle]">
        <div
          class="outer-arc outer-arc_start-a"
          :style="[borderSpinnerStyle, arc(1)]"
        />
        <div
          class="outer-arc outer-arc_end-a"
          :style="[borderSpinnerStyle, arc(1)]"
        />
        <div
          class="outer-arc outer-arc_start-b"
          :style="[borderSpinnerStyle, arc(1)]"
        />
        <div
          class="outer-arc outer-arc_end-b"
          :style="[borderSpinnerStyle, arc(1)]"
        />
        <div
          class="outer-moon-a"
          :style="[backgroundSpinnerStyle, moon(1, 0)]"
        />
        <div
          class="outer-moon-b"
          :style="[backgroundSpinnerStyle, moon(1, 1)]"
        />
      </div>
    </div>
  </div>
...
<script>
import validateDuration from "../components/helpers/validateDuration.js";
import calcPropertyValue from "../components/helpers/calcPropertyValue.js";
