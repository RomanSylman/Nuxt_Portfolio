<template>
    <div>
      ...
      <div class="flex flex-col justify-center items-center mt-20 gap-5">
        ...
        <a href="/files/CV.pdf" class="text-blue-500"><DownloadIcon /></a>
      </div>
    </div>
  </template>
    ...
    data() {
      return {
        socialLinks: [
          {
            name: 'GitHub',
            url: 'https://github.com/RomanSylman',
            icon: GitHubIcon,
          },
          {
            name: 'Instagram',
            url: 'https://www.instagram.com/_.pomah._/',
            icon: InstagramIcon,
          },
          {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/roman-sylman/',
            icon: LinkedInIcon,
          },
        ],
      };
